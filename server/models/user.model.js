...
/**
 * Mongoose Model
 * @property {String} firstName - required, minlength = 2
 * @property {String} lastName, required, minlength = 3
 * @property {String} description - maxlength = 250
 * @property {String} email - required, validated
 * @property {String} loginPw - required, minlength = 8
